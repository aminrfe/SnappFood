...
class CustomerProfile(models.Model):
    ...
    latitude = models.DecimalField(max_digits=9, decimal_places=6, null=True, blank=True)  # For storing latitude
    longitude = models.DecimalField(max_digits=9, decimal_places=6, null=True, blank=True)  # For storing longitude
