...
from .views import CustomerProfileView, FavoriteView, CartListCreateView, CartDetailView, CartItemDeleteView, MenuItemsView, MenuItemDetailView, OrderListCreateView
